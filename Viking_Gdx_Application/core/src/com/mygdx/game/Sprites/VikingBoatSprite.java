...
public class VikingBoatSprite implements com.mygdx.game.Interfaces.ISprite {
    private final String TAG = "VikingBoatSprite";
...
//viking.x = 800 / 2 - VIKING_WIDTH / 2;			// default x-coord positionE
        ...
        vikingSheet = new Texture(Gdx.files.internal("sprites/Valkyrie_Ship.png"));
