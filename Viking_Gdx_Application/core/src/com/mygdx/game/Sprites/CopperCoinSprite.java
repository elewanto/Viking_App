...
public class CopperCoinSprite implements ISprite {
    ...
    public void create(int x , int y ){
        ...
        goldCoin.x = x;
        goldCoin.y = y;
        goldCoinSheet = new Texture(Gdx.files.internal("sprites/coin_copper.png"));
    ...
    public void registerCollision(){
        ...
        if (!taken) {
            MyGdxGame.score += MyGdxGame.COPPER_COIN_SCORE;
            taken = true;
