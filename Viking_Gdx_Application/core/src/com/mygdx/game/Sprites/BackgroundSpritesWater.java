...
public class BackgroundSpritesWater implements ISprite {
    ...
    private static final int levelType = 3; // 1 is grass, 2 is path, 3 is water, and 4 is darGrass
    ...
    public void render(OrthographicCamera camera, SpriteBatch spriteBatch){
        ...
        //NOTE 64 is the height and width in pixels of each square tile.
        for (int j = 0; j < MyGdxGame.SCREEN_HEIGHT /200 +1; j++) {
            for (int i = 0; i < MyGdxGame.LEVEL_WIDTH / 200 + 1; i++) {

                spriteBatch.draw(individualFrames[levelType], i * 200 - shiftPixel, j * 200, 200, 200);
