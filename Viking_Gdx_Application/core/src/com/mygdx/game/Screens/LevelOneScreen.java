...
public class LevelOneScreen implements Screen {
    ...
    ISprite BackgroundSprites = new BackgroundSprites();
    ISprite CrabSprite2 = new CrabSprite();
    ISprite CrabSprite3 = new CrabSprite();
    ISprite CrabSprite4 = new CrabSprite();
    ISprite CrabSprite5 = new CrabSprite();
    ISprite CrabSprite6 = new CrabSprite();
    ISprite CrabSprite7 = new CrabSprite();
    ISprite CrabSprite8 = new CrabSprite();
    ISprite CrabSprite9 = new CrabSprite();
    ISprite CrabSprite10 = new CrabSprite();
    ...
    // constructor
    public LevelOneScreen(final MyGdxGame gam) {
        this.game = gam;
        ...
        CrabSprite2.create(10000,250);
        CrabSprite3.create(25000, 750);
        CrabSprite4.create(40000, 200);
        CrabSprite5.create(33000, 700);
        CrabSprite6.create(21000,0);
        CrabSprite7.create(18000, 300);
        CrabSprite8.create(29000, 700);
        ...
        spriteList.add(CrabSprite2);
        spriteList.add(CrabSprite3);
        spriteList.add(CrabSprite4);
        spriteList.add(CrabSprite5);
        spriteList.add(CrabSprite6);
        spriteList.add(CrabSprite7);
        spriteList.add(CrabSprite8);
    ...
    public void render(float delta) {
        ...
        CrabSprite.render(camera,  game.batch);
        CrabSprite2.render(camera, game.batch);
        CrabSprite3.render(camera, game.batch);
        CrabSprite4.render(camera, game.batch);
        CrabSprite5.render(camera, game.batch);
        CrabSprite6.render(camera, game.batch);
        CrabSprite7.render(camera, game.batch);
        CrabSprite8.render(camera, game.batch);
